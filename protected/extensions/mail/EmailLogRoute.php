 ...
 * 日志发送邮件
 *
 * @author zhanghaisong 2014-4-28
 *
 */
class EmailLogRoute extends CLogRoute
{
        /**
        ...
        protected function sendEmail($email,$subject,$message)
        {
				...
				$mail->addFrom ( 'noreply@zhenpin.com', implode("\r\n",$headers) );  
				$mail->to = explode ( ',', $email );  
				$mail->setBody($message);  
				$success = Yii::app()->mail->send($mail);  
        }
